...
// let withProps = connect(mapStateToProps)(test);
...
function drawFloorPizza(context, diameter, chromList) {
  var radius = diameter / 2;
  context.translate(-radius, radius); // center
